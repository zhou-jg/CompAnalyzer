...
public class JavaPackage implements IDependableEntity{

    private String name;
    private int volatility;
    private HashSet<JavaClass> classes;
    private HashSet<JavaPackage> afferents;
    private HashSet<JavaPackage> efferents;
    ...
    public JavaPackage(String name, int volatility) {
        ...
        afferents = new HashSet<JavaPackage>();
        efferents = new HashSet<JavaPackage>();
    }
    ...
    public int getInterfaceClassCount() {
        int count = 0;
